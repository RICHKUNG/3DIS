...
def main() -> int:
    ...
    parser.add_argument(
        '--config-dir',
        default='configs/multiscan',
        help='Directory containing per-scene YAML configs (default: configs/multiscan)',
    )
    parser.add_argument(
        '--configs',
        nargs='*',
    ...
    from run_workflow import execute_workflow, load_yaml  # noqa: WPS433 (local import)
